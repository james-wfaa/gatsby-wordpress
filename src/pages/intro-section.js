...
<Layout>
    <MobileHr />
    <p>Here is the hero intro section for the home page. It features a taller image than other hero intro sections.</p>
    ...
    <HeroIntroSection
        ...
        />
            <MobileHr />
<p>Clicking on the down carat area will smoothly scroll you down to the heading of the red content area.</p>
<p>...</p><p>...</p><p>...</p>
<p>This next hero intro section is based on the events page. This one features the standard image sizes for a hero section:
  375px at mobile, 500px at tablet, 720px at desktop.
</p>
<p>NOTE: the scroll on this one does not work; it will scroll you back up to the first example. There can only be one of these sections per page.</p>
    <HeroIntroSection
