...
<Layout>
   ...
   <p>These examples use the same set of six "Card D" tiles labeled Slide 1 through Slide 6 for easy reference.</p>
   ...
   <p>This first one has a 1000ms transition speed</p>
        ...
        <p>
        The dots I have already styled so they should be pretty close.  The arrow/carat nav I have not styled yet.</p>
        <p>Positioning of the prev/next nav is also an issue... they need to be absolutely positioned on the left and right, and they are at a different depth level than the slides themselves so 
            we will probably need to adjust their positioning at every breakpoint to get them to fall between the slides as much as possible.
        </p>
