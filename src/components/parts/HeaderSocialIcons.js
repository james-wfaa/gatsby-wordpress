...
const HeaderSocialIcons = ({ classList }) => {
    ...
    return ( 
        <ul className="socialLinks">
            <li><a className="fb" target="_blank" title="Follow WAA on Facebook" href="https://www.facebook.com/wisalumni"><span>Follow WAA on Facebook</span></a></li>
            <li><a className="tw" target="_blank" title="Follow WAA on Twitter" href="https://www.twitter.com/wisalumni"><span>Follow WAA on Twitter</span></a></li>
