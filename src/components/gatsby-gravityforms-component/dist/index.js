...
var _index = require("react-hook-form/dist/index.ie11");
    ...
    if (!formLoading) {
      ...
      if ((0, _manageFormData.submissionHasOneFieldEntry)(values)) {
        ...
        const {
          data,
          status
        } = await (0, _passToGravityForms.default)({
        ...
        if (status === 'success') {
          ...
          setConfirmationMessage(confirmation_message || (confirmation === null || confirmation === void 0 ? void 0 : confirmation.message) || false);
          successCallback({
            values,
            reset,
            confirmations
